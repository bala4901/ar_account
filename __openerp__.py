...
##############################################################################
{
    ...
    'data' : [  'security/ir.model.access.csv',
                ...
                'security/data_GroupsInternalTransfer.xml',
                'data/data_VoucherType.xml',
                'workflow/workflow_AccountVoucher.xml',
                'workflow/workflow_InternalTransfer.xml',
                ...
                'view/view_InternalTransfer.xml',
                ...
                'window_action/waction_InternalTransfer.xml',

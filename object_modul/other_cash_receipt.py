...
class other_cash_receipt(osv.osv):
	_name = 'account.other_cash_receipt'
	_inherit = 'account.voucher'
	_table = 'account_voucher'
	_description = 'Other Cash Receipt'
	_order = 'name'
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(other_cash_receipt, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(other_cash_receipt, self).unlink(cr, uid, ids, context)

...
class account_invoice_type(osv.osv):
	...
	_description = 'Tipe Invoice'
	_columns = {
		'name' : fields.char('Tipe Invoice', size=100, required=True),
		'kode' : fields.char('Kode', size=30, required=True),
		'property_sequence_invoice' : fields.property('ir.sequence', type='many2one', relation='ir.sequence', string='Invoice Sequence', method=True, view_load=True),
		}
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(account_invoice_type, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(account_invoice_type, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(account_invoice_type, self).unlink(cr, uid, ids, context)
		else:

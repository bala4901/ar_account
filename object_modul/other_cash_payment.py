...
class other_cash_payment(osv.osv):
	_name = 'account.other_cash_payment'
	_inherit = 'account.voucher'
	_table = 'account_voucher'
	_description = 'Other Cash Payment'
	_order = 'name'
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(other_cash_payment, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(other_cash_payment, self).unlink(cr, uid, ids, context)

...
class customer_invoice(osv.osv):
	_name = 'account.customer_invoice'
	...
	def create(self, cr, uid, value, context=None):
		...
		"""
		new_id = super(customer_invoice, self).create(cr, uid, value, context)
	...
	def unlink(self, cr, uid, ids, context=None):
		...
		return super(customer_invoice, self).unlink(cr, uid, ids, context)

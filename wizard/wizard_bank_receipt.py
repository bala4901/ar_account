...
class wizard_bank_receipt(osv.osv_memory):
    _name = 'account.wizard_bank_receipt'
    _description = 'Wizard bank Receipt'
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type=False, context=None, toolbar=False, submenu=False):
        res = super(wizard_bank_receipt, self).fields_view_get(cr, uid, view_id=view_id, view_type=view_type, context=context, toolbar=toolbar, submenu=submenu)
        x = []
    ...
    def view_init(self, cr, uid, fields_list, context=None):
        ...
        res = super(wizard_bank_receipt, self).view_init(cr, uid, fields_list, context=context)
    ...
    def bank_receipt(self, cr, uid, ids, context=None):
        obj_account_bank_receipt = self.pool.get('account.bank_receipt')
        ...
        voucher_type_ids = obj_account_voucher_type.search(cr, uid, [('name','=','Bank Receipt')])[0]
        ...
        return  {
                        'res_id' : new_account_bank_receipt_id,
                        'name' : 'Bank Receipt',
                        'view_type' : 'form',
                        'view_mode' : 'form',
                        'res_model' : 'account.bank_receipt', #TODO

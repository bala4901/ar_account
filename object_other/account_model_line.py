...
class account_model_line(osv.osv):
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(account_model_line, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(account_model_line, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(account_model_line, self).unlink(cr, uid, ids, context)
		else:

...
class res_company(osv.osv):
	...
	_columns =	{
							...
							'account_production_expense_id' : fields.many2one(string='Production Expense Account', obj='account.account', domain=[('type','=','view')]),
							'account_expense_id' : fields.many2one(string='Operating Expense Account', obj='account.account', domain=[('type','=','view')]),

...
class timesheet_invoice(osv.osv):
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(timesheet_invoice, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(timesheet_invoice, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(timesheet_invoice, self).unlink(cr, uid, ids, context)
		else:

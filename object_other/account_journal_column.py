...
class account_journal_column(osv.osv):
	...
	_inherit = 'account.journal.column'
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(account_journal_column, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(account_journal_column, self).copy(cr, uid, id, default, context)
		else:
	...
	def unlink(self, cr, uid, ids, context={}):
		...
		if situasi == 'aman':
			return super(account_journal_column, self).unlink(cr, uid, ids, context)
		else:

...
class account_bank_statement_line(osv.osv):
	...
	def create(self, cr, uid, values, context={}):
		...
		if situasi == 'aman':
			return super(account_bank_statement_line, self).create(cr, uid, values, context)
		else:
	...
	def copy(self, cr, uid, id, default=None, context={}):
		...
		if situasi == 'aman':
			return super(account_bank_statement_line, self).copy(cr, uid, id, default, context)
		else:
